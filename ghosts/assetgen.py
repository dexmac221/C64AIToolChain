...
SPRITES = [
    # 0 STAND - shield edge-on, facing right
    ("ART_STAND", [
        "            ",
        "      +     ",
        "     ++     ",
    ...
    # 2 RUN B - legs passing under him
    ("ART_RUN2", [
        "            ",
        "      +     ",
        "     ++     ",
    ...
    # 3 JUMP - knees up, shield over the helmet
    ("ART_JUMP", [
        "            ",
        "      +     ",
        "     ++     ",
    ...
    # 4 THROW - arm out, lance leaving his hand
    ("ART_THROW", [
        "            ",
        "      +     ",
        "     ++     ",
    ...
    # 6 ZOMBIE RISING - arms first, clawing out of the soil
    ("ZOM_RISE", [
        "  ++    ++  ",
        "  ##    ##  ",
        "  ##    ##  ",
    ...
    # 7 ZOMBIE WALK A - reaching, dragging a foot
    ("ZOM_WALK1", [
        "            ",
        "            ",
        "    ####    ",
    ...
    # 8 ZOMBIE WALK B - the lurch onto the other foot
    ("ZOM_WALK2", [
        "            ",
        "            ",
        "            ",
