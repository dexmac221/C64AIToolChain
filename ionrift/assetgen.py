...
TILES = [
    ...
    # 7: STAR_NEAR - foreground twinkle, bright core from colour RAM
    ("STAR_NEAR", "mc", [
        "    ",
        "    ",
        " +  ",
    ...
    # 8: STAR_MID - mid plane, shared colour $D023
    ("STAR_MID", "mc", [
        "    ",
        "    ",
        "  + ",
    ...
    # 9: STAR_FAR - far plane, dim shared colour $D022
    ("STAR_FAR", "mc", [
        "    ",
        "    ",
        "    ",
    ...
    # 10: HUDLINE - hires separator bar
    ("HUDLINE", "hi", [
        "        ",
        "        ",
        "########",
...
SPRITES = [
    ...
    # 7-10: explosion - flash, fireball, breaking ring, debris.
    # '.' = shared orange, '+' = shared white, '#' = cycling sprite colour
    ("EXPL0", [
        "            ",
        "            ",
        "            ",
